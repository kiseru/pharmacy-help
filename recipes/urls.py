...
urlpatterns = [
    ...
    url('^medicine/', TemplateView.as_view(template_name='index.html')),
    url('^medicine/add/', TemplateView.as_view(template_name='index.html')),
    url('^recipes/<str:token>', TemplateView.as_view(template_name='index.html')),
